...
link86 motorMn.obj, init.obj, motor.obj, motorTmr.obj, trigTbl.obj to link1.lnk
link86 converts.obj, serial.obj, queue.obj, initSeri.obj, events.obj to link2.lnk
